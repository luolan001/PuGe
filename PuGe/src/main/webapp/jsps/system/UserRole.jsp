            ...
            <div id="toolbar_a" class="search" style="padding-top: 20px;padding-left: 10px;">
	            <form class="form-inline">
				  <div class="form-group">
				    ...
				    <input type="text" class="form-control" id="userId2" placeholder="userId2">
				  </div>
				  <div class="form-group">
				    <label for="roleId2">角色ID：</label>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form role="form" action="javascript:void(0)" id="addForm">
	                        <div class="form-group">
	                            <label for="txt_userId">userId</label>
	                            <input type="text" name="userId" data-bind="value:ordertime" class="form-control"
	                                   id="txt_userId"
	                                   placeholder="userId">
	                        </div>
	                        <div class="form-group">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form role="form" id="updateForm">
                            <div class="form-group">
                                <input type="text" class="form-control" name="userRoleId" id="userRoleId" readonly>
                            </div>
                            <div class="form-group">
...
<script type="text/javascript">
    $(function(){
        ...
        $('#table').bootstrapTable({
            url: "userRole/userRolePageQuery.action",//这个接口需要处理bootstrap table传递的固定参数
            method: 'post',
            ...
            columns: [{
                ...
                formatter: function (value, row, index) {
                    var edit =
                        ...
                        row.userRoleId + '\',\'' + row.userId + '\',\'' + row.roleId +
                        '\',\'' +row.description +
        ...
        $("#btn_search_b").click(function(){
        	 var obj = {
	    			url:"userRole/userRolePageQuery.action",
	    			queryParams:function queryParams(params){
	    				return{
	    					pageSize:params.pageSize,
	    					pageNumber:params.pageNumber,
        ...
        $("#addRecord").click(function(){
            ...
            $.ajax({
                url: "userRole/addUserRole.action",
                dataType:"json",
                type: "post",
                data: data,
        ...
        $("#updateRecord").click(function(){
            ...
            $.ajax({
                url: "userRole/updateUserRole.action",
                dataType: "json",
                type: "post",
                data: data,
    ...
    //显示更新模态框
    function showUpdateModal(userRoleId, userId, roleId, description){
    ...
    function dels(ids) {
        if(confirm("确定删除选中记录吗?")){
            ...
            $.ajax({
                url : "userRole/deleteUserRole.action?ids=" + ids,
                type : "post",
